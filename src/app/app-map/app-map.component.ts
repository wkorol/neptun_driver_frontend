...
export class AppMapComponent {
  ...
  airportFixedPrice: google.maps.LatLngLiteral[] = [
    { lat: 54.37975171955887, lng: 18.45165809274431 },
    { lat: 54.36879478533791, lng: 18.49741816358616 },
    { lat: 54.37743554475597, lng: 18.502885044432446 },
    { lat: 54.38711990361483, lng: 18.456998619578798 },
    { lat: 54.379855468785365, lng: 18.45159864937105 },
    { lat: 54.37975171955887, lng: 18.45165809274431 } // zamknięcie polygonu
  ];
