...
export class AppMapComponent {
  ...
  airportFixedPrice: google.maps.LatLngLiteral[] = [
    { lat: 54.3939519, lng: 18.4650993 },
    { lat: 54.3870053, lng: 18.5053539 },
    { lat: 54.3699586, lng: 18.4948826 },
    { lat: 54.3804074, lng: 18.4450150 },
    { lat: 54.3939019, lng: 18.4648418 },
    { lat: 54.3939519, lng: 18.4650993 } // zamknięcie polygonu
  ];
